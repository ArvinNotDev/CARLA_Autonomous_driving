...
LANE_CHANGE_PLANNER_CHECK_INTERVAL_SECONDS = 0.50
VISION_DEBUG = False
...
TRAJECTORY_DEBUG_SCALE = 2.2
JUNCTION_STATIC_THROTTLE = 0.20
JUNCTION_STATIC_TIMEOUT_SECONDS = 20.0
JUNCTION_ENTRY_DISTANCE_M = 11.0
JUNCTION_RIGHT_TURN_DISTANCE_M = 6.0
JUNCTION_LEFT_STRAIGHT_DISTANCE_M = 10.0
JUNCTION_LEFT_TURN_DISTANCE_M = 4.0
JUNCTION_STRAIGHT_DISTANCE_M = 3.0
JUNCTION_TRAJECTORY_WINDOW_SECONDS = 6.0
DRIVABLE_RECOVERY_ENABLED = True
DRIVABLE_RECOVERY_ERROR_THRESHOLD = 20.0
DRIVABLE_RECOVERY_WINDOW_SECONDS = 10.0
DRIVABLE_RECOVERY_STEER = 0.45
DRIVABLE_RECOVERY_THROTTLE = 0.20
DEBUG_SHOW_ROIS = True
DEBUG_SHOW_LANE_MASK = False
DEBUG_SHOW_DRIVABLE_AREA = True
...
class PipelineConfig:
    ...
    # Training image size
    model_image_size: Tuple[int, int] = (160, 160)
