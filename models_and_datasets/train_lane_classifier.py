...
def train(args):
    ...
    train_ds = LaneSideDataset(train_samples, tfm=train_tfm)
    val_ds = LaneSideDataset(val_samples, tfm=eval_tfm)
    test_ds = LaneSideDataset(test_samples, tfm=eval_tfm)
...
def parse_args():
    ...
    p.add_argument("--data_dir", type=str, default="dataset_lane")
    p.add_argument("--out", type=str, default="lane_side_model_resnet18.pt")
